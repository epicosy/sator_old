...
from sator.utils.misc import extract_company
from sator.core.graphql.objects import Vulnerability, VulnerabilityModel, CWE, CWEModel, VulnerabilityCWEModel, \
    Commit, CommitModel, ConfigurationVulnerabilityModel, Repository, RepositoryModel, GrapheneCount, Reference, \
    ReferenceTagModel, TagModel, Tag, RepositoryProductType, ProductTypeModel, ConfigurationModel, Configuration, \
    Grouping, GroupingModel, VendorModel, Product, ProductModel, CommitFile, CommitFileModel, ProductType,\
    RepositoryProductTypeModel, VulnerabilityCWE, RepositoryTopicModel, TopicModel
